...
export const useSuccessHandler = () => {
  const handleSuccess = useCallback((title: string, message: string, onConfirm?: () => void) => {
...
export const globalSuccessHandler = (title: string, message: string, onConfirm?: () => void) => {
  showSuccess(title, message, onConfirm)
} 