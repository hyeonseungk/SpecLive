...
interface SortableActorCardProps {
  actor: Tables<"actors">;
  onSelect: (actor: Tables<"actors">) => void;
  onEdit: (actor: Tables<"actors">) => void;
  onDelete: (actor: Tables<"actors">) => void;
  isSelected: boolean;
  membership: Tables<"memberships"> | null;
}

export default function SortableActorCard({
  actor,
  onSelect,
  onEdit,
  onDelete,
